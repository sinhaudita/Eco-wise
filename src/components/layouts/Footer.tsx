...
import { Leaf, Instagram, Twitter, Facebook, Github } from 'lucide-react';
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">EarthWise Paths</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>contact@earthwisepaths.com</li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-sm text-earthwise-neutral-light">
          <div className="flex flex-col md:flex-row justify-between">
            <p>&copy; {new Date().getFullYear()} EarthWise Paths. All rights reserved.</p>
