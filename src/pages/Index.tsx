        ...
        <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 text-white">
            ...
            <p className="text-lg mb-8 text-white/90">
              EarthWise Paths helps you understand your environmental impact and provides personalized suggestions to reduce your carbon footprint - without compromising your lifestyle.
            </p>
